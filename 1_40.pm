...
########################################################################
package CAD::Format::DWG::1_40::EntityRepeatBegin;
...
########################################################################
package CAD::Format::DWG::1_40::EntityTmp;
...
########################################################################
package CAD::Format::DWG::1_40::EntitySolid;
...
########################################################################
package CAD::Format::DWG::1_40::EntityBlockEnd;
...
########################################################################
package CAD::Format::DWG::1_40::EntityTrace;
...
########################################################################
package CAD::Format::DWG::1_40::EntityBlockInsert;
...
########################################################################
package CAD::Format::DWG::1_40::EntityBlockBegin;
...
########################################################################
package CAD::Format::DWG::1_40::EntityFoo;
...
sub _read {
    ...
    if ($_on == $CAD::Format::DWG::1_40::ENTITIES_SOLID) {
        $self->{data} = CAD::Format::DWG::1_40::EntitySolid->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::1_40::ENTITIES_SHAPE) {
        $self->{data} = CAD::Format::DWG::1_40::EntityShape->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::1_40::ENTITIES_REPEAT_BEGIN) {
        $self->{data} = CAD::Format::DWG::1_40::EntityRepeatBegin->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::1_40::ENTITIES_BLOCK_BEGIN) {
        $self->{data} = CAD::Format::DWG::1_40::EntityBlockBegin->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::1_40::ENTITIES_LINE) {
        $self->{data} = CAD::Format::DWG::1_40::EntityLine->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::1_40::ENTITIES_REPEAT_END) {
        $self->{data} = CAD::Format::DWG::1_40::EntityRepeatEnd->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::1_40::ENTITIES_LOAD) {
        $self->{data} = CAD::Format::DWG::1_40::EntityLoad->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::1_40::ENTITIES_FOO) {
        $self->{data} = CAD::Format::DWG::1_40::EntityFoo->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::1_40::ENTITIES_TEXT) {
        $self->{data} = CAD::Format::DWG::1_40::EntityText->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::1_40::ENTITIES_BLOCK_INSERT) {
        $self->{data} = CAD::Format::DWG::1_40::EntityBlockInsert->new($self->{_io}, $self, $self->{_root});
    }
    ...
    elsif ($_on == $CAD::Format::DWG::1_40::ENTITIES_BLOCK_END) {
        $self->{data} = CAD::Format::DWG::1_40::EntityBlockEnd->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::1_40::ENTITIES_POINT) {
        $self->{data} = CAD::Format::DWG::1_40::EntityPoint->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::1_40::ENTITIES_TRACE) {
        $self->{data} = CAD::Format::DWG::1_40::EntityTrace->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::1_40::ENTITIES_TMP) {
        $self->{data} = CAD::Format::DWG::1_40::EntityTmp->new($self->{_io}, $self, $self->{_root});
    }
}
...
########################################################################
package CAD::Format::DWG::1_40::EntityShape;
...
########################################################################
package CAD::Format::DWG::1_40::EntityRepeatEnd;
...
########################################################################
package CAD::Format::DWG::1_40::EntityLoad;
