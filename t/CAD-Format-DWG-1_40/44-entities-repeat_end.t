...
isa_ok($entity3, 'CAD::Format::DWG::1_40::Entity');
...
my $x = unpack 'd<', $repeat1_data->column_distance;
is($x, 1, 'Repeat end column distance (1).');
my $y = unpack 'd<', $repeat1_data->row_distance;
is($y, 0, 'Repeat end row distance (0).');
