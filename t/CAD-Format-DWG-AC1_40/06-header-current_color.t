...
is($obj->header->current_color, 1, 'Actual color 1 (minimum).');

# Test.
$obj = CAD::Format::DWG::AC1_40->from_file(
	$data_dir->file('COLOR2.DWG')->s,
);
is($obj->header->current_color, 2, 'Actual color 2.');

# Test.
$obj = CAD::Format::DWG::AC1_40->from_file(
	$data_dir->file('COLOR127.DWG')->s,
);
is($obj->header->current_color, 127, 'Actual color 127 (maxium).');
