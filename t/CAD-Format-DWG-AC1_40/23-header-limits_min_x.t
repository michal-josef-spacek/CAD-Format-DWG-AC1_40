...
is($obj->header->limits_min_x, -123456789.1234, 'Limits min x (-123456789.1234).');

# Test.
$obj = CAD::Format::DWG::AC1_40->from_file(
	$data_dir->file('LIM2.DWG')->s,
);
is($obj->header->limits_min_x, 0, 'Limits min x (0).');

# Test.
$obj = CAD::Format::DWG::AC1_40->from_file(
	$data_dir->file('LIM3.DWG')->s,
);
is($obj->header->limits_min_x, -1, 'Limits min x (-1).');
