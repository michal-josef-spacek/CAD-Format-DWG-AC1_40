...
is($obj->header->limits_max_y, 9, 'Limits max y (9).');
...
is($obj->header->limits_max_y, 0, 'Limits max y (0).');

# Test.
$obj = CAD::Format::DWG::AC1_40->from_file(
	$data_dir->file('LIM4.DWG')->s,
);
is($obj->header->limits_max_y, 123456789.1234, 'Limits max y (123456789.1234).');
